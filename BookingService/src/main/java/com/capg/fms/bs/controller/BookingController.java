...
public class BookingController {
	...
	public String addBookingDetails(@Valid @RequestBody() Booking book, BindingResult br)
		...
		Booking b = bookingService.addBookingDetails(book);
	...
	public String deleteBookingDetails(@PathVariable long bookingId, Booking book) {

		bookingService.deleteBookingDetails(bookingId, book);
